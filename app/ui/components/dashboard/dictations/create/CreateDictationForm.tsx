...
import { Dictation, LANGUAGE_CODES, User } from '@/app/lib/definitions';
import {
  CheckIcon,
  DocumentTextIcon,
  LanguageIcon,
    ...
    <form action={dispatch}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <select aria-describedby="language-code-error" name="language_code" id="language_code" className="peer block rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500">
        ...
        <div className="mb-4">
          ...
          <div className="mt-2 rounded-md">
            <input onInput={handleSpeedChange} type="range" min="0.5" max="1" step="0.1" id="speed" name="speed" defaultValue={speed} aria-describedby="content-speed"/>
            <div>{speed}</div>
          </div>
          <div id="content-error" aria-live="polite" aria-atomic="true">
            {state.errors?.content &&
